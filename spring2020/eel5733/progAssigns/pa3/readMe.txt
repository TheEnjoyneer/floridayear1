...
For Testing My Program:
	Prerequisites
	- A text file of  input
	- A text file of expected output

	Running
	1) Run "run.sh <inputFile> <numWorkerThreads> <outputFileName>"
...
For Running My Program Normally:
	...
	Running
	1) Run "./transfProg <inputFileName> <numWorkerThreads>"